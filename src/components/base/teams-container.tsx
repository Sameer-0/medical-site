            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-10 mx-auto">
                    <div className="lg:-mx-6 lg:flex lg:items-center">
                        <Image className="object-cover object-center lg:w-1/3 lg:mx-6 w-full h-72 rounded-lg lg:h-[25rem]" width={500} height={500} src="/images/pages/landing/profile.jpg" alt="Member" />
                ...
                <div className="container px-6 py-10 mx-auto">
                    <div className="lg:flex lg:items-center lg:justify-between">
                        <div className="lg:w-1/2 lg:order-2 lg:ml-6">
                            <Image className="object-cover object-center w-500 lg:w-3/4 sm:w-full h-72 rounded-lg lg:h-[25rem]" width={500} height={500} src="/images/pages/landing/profile.jpg" alt="Member" />
                        </div>
