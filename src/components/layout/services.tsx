	...
	<div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
        ...
        <Link href="https://www.accttexas.org" >
          <div className="flex flex-col justify-center m-8 text-center">
            <Image alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover dark:bg-gray-500 hover:scale-105 transition-all duration-400 hover:bg-gray-200" src="/images/pages/landing/acct.png" width={1000} height={1000}/>
        ...
        <Link href="https://www.coastalhw.org" >
          <div className="flex flex-col justify-center m-8 text-center">
            <Image alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover dark:bg-gray-500 hover:scale-105 transition-all duration-400 hover:bg-gray-200" src="/images/pages/landing/chaw.png" width={1000} height={1000}/>
        ...
        <Link href="https://www.utmb.edu" >
          <div className="flex flex-col justify-center m-8 text-center">
            <Image alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover dark:bg-gray-500 hover:scale-105 transition-all duration-400 hover:bg-gray-200" src="/images/pages/landing/umat.png" width={1000} height={1000}/>
      ...
      <div className="flex flex-row flex-wrap-reverse justify-center">
        <Link href="https://aidsetc.org/about/aetc-ncrc" >
          <div className="flex flex-col justify-center m-8 text-center">
            <Image alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover dark:bg-gray-500 hover:scale-105 transition-all duration-400 hover:bg-gray-200" src="/images/pages/landing/aets.jpg" width={1000} height={1000}/>
        ...
        <Link href="https://www.stvhope.org/" >
          <div className="flex flex-col justify-center m-8 text-center">
            <Image alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover dark:bg-gray-500 hover:scale-105 transition-all duration-400 hover:bg-gray-200" src="/images/pages/landing/hope.webp" width={1000} height={1000}/>
            <p className="text-xl font-semibold leading-tight">HOPE</p>
            <p className="dark:text-gray-600">St. Vincent's House</p>
          </div>
        </Link>
        <Link href="https://www.gchd.org" >
          <div className="flex flex-col justify-center m-8 text-center">
            <Image alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover dark:bg-gray-500 hover:scale-105 transition-all duration-400 hover:bg-gray-200" src="/images/pages/landing/gche.png" width={1000} height={1000}/>
