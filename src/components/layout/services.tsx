...
<section className="py-6 dark:bg-gray-100 dark:text-gray-800">
	<div className="flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
        ...
        <Link href="https://www.accttexas.org" target="_blank">
          <div className="flex flex-col justify-center m-8 text-center hover:scale-105 transition-all">
            <Image alt="" className="self-center flex-shrink-0 w-full md:w-[80%] h-32 mb-4 bg-center bg-cover dark:bg-gray-500 transition-all duration-400" src="/images/pages/landing/acct.png" width={1000} height={1000}/>
        ...
        <Link href="https://www.coastalhw.org" target="_blank">
          <div className="flex flex-col justify-center m-8 text-center hover:scale-105 transition-all">
            <Image alt="" className="self-center flex-shrink-0 w-full md:w-[80%] h-32 mb-4 bg-center bg-cover dark:bg-gray-500 transition-all duration-400" src="/images/pages/landing/chaw.png" width={1000} height={1000}/>
        ...
        <Link href="https://www.utmb.edu" target="_blank">
          <div className="flex flex-col justify-center m-8 text-center hover:scale-105 transition-all">
            <Image alt="" className="self-center flex-shrink-0 w-full md:w-[80%] h-32 mb-4 bg-center bg-cover dark:bg-gray-500 transition-all duration-400" src="/images/pages/landing/umat.png" width={1000} height={1000}/>
        ...
        <Link href="https://aidsetc.org/about/aetc-ncrc" target="_blank">
          <div className="flex flex-col justify-center m-8 text-center hover:scale-105 transition-all">
            <Image alt="" className="self-center flex-shrink-0 w-full md:w-[80%] h-32 mb-4 bg-center bg-cover dark:bg-gray-500 transition-all duration-400" src="/images/pages/landing/aets.jpg" width={1000} height={1000}/>
        ...
        <Link href="https://www.stvhope.org/" target="_blank">
          <div className="flex flex-col justify-center m-8 text-center hover:scale-105 transition-all">
            <Image alt="" className="self-center flex-shrink-0 w-full md:w-[80%] h-32 mb-4 bg-center bg-cover dark:bg-gray-500 transition-all duration-400" src="/images/pages/landing/hope.webp" width={1000} height={1000}/>
        ...
        <Link href="https://www.gchd.org" target="_blank">
          <div className="flex flex-col justify-center m-8 text-center hover:scale-105 transition-all">
            <Image alt="" className="self-center flex-shrink-0 w-28 h-28 mb-4 bg-center bg-cover dark:bg-gray-500 transition-all duration-400" src="/images/pages/landing/gche.png" width={1000} height={1000}/>
